...
# ── AgAI_26 Addition ─────────────────────────────────────────────────────────
# Synchronous OpenAI client for structured output parsing (beta.chat.completions.parse)
from openai import OpenAI

def get_openai_client() -> OpenAI:
    """
    Returns a synchronous OpenAI client for use in AgAI_26 agents.
    Uses beta.chat.completions.parse for Pydantic-enforced structured outputs.
    """
